...
class InventariosControllerTest < ActionController::TestCase
  ...
  test "should create inventario" do
    assert_difference('Inventario.count') do
      post :create, inventario: { id_tipo: @inventario.id_tipo, nombre: @inventario.nombre, precio_compra: @inventario.precio_compra, precio_venta: @inventario.precio_venta, shipping: @inventario.shipping }
    end
  ...
  test "should update inventario" do
    patch :update, id: @inventario, inventario: { id_tipo: @inventario.id_tipo, nombre: @inventario.nombre, precio_compra: @inventario.precio_compra, precio_venta: @inventario.precio_venta, shipping: @inventario.shipping }
    assert_redirected_to inventario_path(assigns(:inventario))
  end
